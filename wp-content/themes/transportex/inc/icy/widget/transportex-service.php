...
class transportex_service_widget extends WP_Widget {    
	...
	?>
				...
				<td>
				  <label for="<?php echo $this->get_field_id( 'fa_icon' ); ?>"><?php _e( 'Enter  Font Awesome icon class ( like: fa-cloud ). <a href="https://fontawesome.com/v4.7.0/icons/" target="blank" >Here all icon </a>','transportex' ); ?></label> 
