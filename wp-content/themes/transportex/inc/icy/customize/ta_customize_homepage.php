<?php function transportex_homepage_setting( $wp_customize ) { 
			...
			$wp_customize->add_setting(
				'Transportex_Customize_Alpha_Color_Control', array( 'sanitize_callback' => 'sanitize_text_field',
				
			) );
			
			$wp_customize->add_control(new WP_Customize_Color_Control( $wp_customize,'Transportex_Customize_Alpha_Color_Control', array(
		   ...
		   $wp_customize->add_setting(
			...
			$wp_customize->add_control( new transportex_service_Customize_Control( $wp_customize, 'service_widget', array(	
				'section' => 'transportex_service_section_settings',
			) )	);
