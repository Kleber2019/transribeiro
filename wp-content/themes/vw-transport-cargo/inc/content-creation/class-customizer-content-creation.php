...
if ( ! class_exists( 'VW_Transport_Cargo_Content_Creation' ) ) :

	/**
	 * VW_Transport_Cargo_Content_Creation class.
	 */
	class VW_Transport_Cargo_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Transport_Cargo_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Transport_Cargo_Content_Creation' );
