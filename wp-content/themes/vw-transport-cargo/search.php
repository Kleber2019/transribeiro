...
<div class="container">
    ...
    <?php
        $theme_lay = get_theme_mod( 'vw_transport_cargo_theme_options','Right Sidebar');
        if($theme_lay == 'Left Sidebar'){ ?>
            <div class="row m-0">
                ...
                <div id="our-services" class="services col-lg-8 col-md-8">
                    ...
                    printf( esc_html__( 'Results For: %s','vw-transport-cargo'), esc_html( get_search_query() ) ); ?></h1> 
                    <?php if ( have_posts() ) :
                        /* Start the Loop */
                    ...
                    <div class="navigation">
                        <?php
                            ...
                            the_posts_pagination( array(
                                'prev_text'          => __( 'Previous page', 'vw-transport-cargo' ),
                                'next_text'          => __( 'Next page', 'vw-transport-cargo' ),
                                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'vw-transport-cargo' ) . ' </span>',
                            ) );
                        ?>
